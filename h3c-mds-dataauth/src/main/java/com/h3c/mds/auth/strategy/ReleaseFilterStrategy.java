...
@Scope("prototype")
@Component("releaseFilterStrategy")
public class ReleaseFilterStrategy extends AbstractFilterStrategy{
    ...
    protected TreeLevel getTreeLevel() {
        if(this.filterParam instanceof MapperMethod.ParamMap){
            ...
            if(param.get("id") == null){
                ...
                return new TreeLevel(FilterConstant.LEVEL_TYPE_BASE,"IBDS_RELEASE","RELEASENo","Readers","releaseno");
            }
        }
        return null;
    }
