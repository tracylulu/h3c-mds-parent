...
@Scope("prototype")
@Component("subsystemFilterStrategy")
public class SubsystemFilterStrategy extends AbstractFilterStrategy{
    @Override
    protected TreeLevel getTreeLevel() {
        if(this.filterParam instanceof MapperMethod.ParamMap){
            ...
            if(param.get("id") == null){
                ...
                return new TreeLevel(FilterConstant.LEVEL_TYPE_BASE,"IBDS_SUB_SYSTEM","SUBSYSTEMNo","Readers","subsystemno");
            }
        }
        return null;
    }
