...
@Scope("prototype")
@Component("featureFilterStrategy")
public class FeatureFilterStrategy extends AbstractFilterStrategy{
    @Override
    protected TreeLevel getTreeLevel() {
        if(this.filterParam instanceof MapperMethod.ParamMap){
            ...
            if(param.get("id") == null){
                ...
                return new TreeLevel(FilterConstant.LEVEL_TYPE_BASE,"IBDS_FEATRUE","FEATURENo","Readers","featureno");
            }
        }
        return null;
    }
