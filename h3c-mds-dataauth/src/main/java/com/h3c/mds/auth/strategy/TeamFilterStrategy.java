...
@Scope("prototype")
@Component("teamFilterStrategy")
public class TeamFilterStrategy extends AbstractFilterStrategy{
    @Override
    protected TreeLevel getTreeLevel() {
        if(this.filterParam instanceof MapperMethod.ParamMap){
            ...
            if(param.get("id") == null){
                ...
                return new TreeLevel(FilterConstant.LEVEL_TYPE_BASE,"IBDS_TEAM","TEAMNo","Readers","teamno");
            }
        }
        return null;
    }
