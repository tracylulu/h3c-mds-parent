...
@Scope("prototype")
@Component("baselineFilterStrategy")
public class BaselineFilterStrategy extends AbstractFilterStrategy{
    @Override
    protected TreeLevel getTreeLevel() {
        if(this.filterParam instanceof MapperMethod.ParamMap){
            ...
            if(param.get("id") == null){
                ...
                return new TreeLevel(FilterConstant.LEVEL_TYPE_BASE,"IBDS_BASE_LINE","BASELINENo","Readers","baselineno");
            }
        }
        return null;
    }
