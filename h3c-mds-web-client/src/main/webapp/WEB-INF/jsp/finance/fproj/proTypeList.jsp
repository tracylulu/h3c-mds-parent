...
<body>
	<!-- <input onkeydown="inpKeyDown();" id="searchParas" class="easyui-textbox" prompt="请输入搜索内容"  style="width: 75%;width: 70%; height: 20px; line-height: 20px;margin-left:7px"   />
	<a href="javascript:void(0)" class="easyui-linkbutton default" onclick="doSearch();">搜 索 </a>
	
		
		<table id="ttProType"></table> -->
...
<script type="text/javascript">
	...
	function initGrid(){
		...
		$("#ttProType").treegrid({
            title:"按产品线、项目类别查询",
            url: "/finance/fprojectCode/listOfProjectCodeByProjType",
            method : 'get',
            idField : 'id',
            ...
            <%} %> --%>
            {
                ...
                handler : function() {
                    $("#ttProType").treegrid("collapseAll");
                }
            },"-",
            {
                id : 'reload${id_suffix }',
            ...
            columns: [[
				...
				{field:'tmpId',title:'tmpId',hidden:true},
    	        {field:'fProductlineName',title:'所属产品线',width:"250px", formatter:formatProgress${id_suffix}},  
    	        {field:'fObjcaName',title:'项目类别',width:"6%"}, 
                {field:'fProjno',title:'项目编码',width:"6%"},    
    	        {field:'fProjname',title:'项目名称',width:"6%"},    
            ...
            onBeforeExpand : function(row) {//异步架加载树
				...
				var url = "/finance/fprojectCode/listOfProjectCodeByProjType";
				$("#ttProType").treegrid("options").url = url;
				return true;
			},
	...
	function doSearch${id_suffix}(){
		$("#ttProType").treegrid("load",{
			searchParams:$("#searchStr${id_suffix}").val(),
