...
<body>
    ...
    <form method='post' name='productCodeApply${timestamp}' id='productCodeApply${timestamp}' >
        <p style="text-align: center;">
            <span style="font-size: 20px;">产品编码申请表 </span>
        </p>
                ...
                <table class="product-code" border="1" cellspacing="0" width="98%" style="border-color:#ABABAB;margin:auto">
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <tr>
                                <td width="50%">&nbsp;&nbsp;变动类型：${entity.applyType=='1'?"新增":entity.applyType=='2'?"改变":entity.applyType=='3'?"停用":""}</td>
                                <td width="50%">&nbsp;&nbsp;申请编码的数目：<span>${applyCount}</span>
