...
<script type="text/javascript">
		...
		$("#tbl_grid${timestamp}").datagrid({
		    title:"项目编码申请",
		    striped:true, 
		    url: "projectWebFlow/findProjectCodeByApplyNo",
		    ...
		    columns: [[
		        ...
		        {field: 'processInsId', hidden:true},
		        {field: "applyNo",title: "申请编号",align: "center",width:260, formatter:formatProgress},
			...
			onDblClickRow : function(index, rowData) {
				var appplyNo = rowData.applyNo;
				if(appplyNo.startsWith("OBC")){
		        $('#mainUrl')
		            .tabs(
		                'add',
		                {
		                    title : "查看项目编码申请",
		                    href : '/projectWebFlow/edit?applyNo='+appplyNo,
		                    closable : true
		                });
