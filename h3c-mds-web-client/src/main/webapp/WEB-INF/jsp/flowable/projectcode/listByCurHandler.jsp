...
<script type="text/javascript">
		...
		$("#tbl_grid${timestamp}").treegrid({
		    ...
		    columns: [[
		        ...
		        {field: "curDeal",title: "当前责任人",align: "left",width:'13%', formatter:formatProgress},
		        {field: "applyNo",title: "申请编号",align: "center",width:'13%'},
		        {field: "proName", title: "项目名称", align: "center",width:'15%'},
		        {field: "dept",title: "申请部门",align: "center",width:'13%'},
		        {field: "applyer",title: "申请人",align: "center",width:'13%'},
		        {field: "curStatus", title: "状态", align: "center",width:'13%'},
		        {field: "optType", title: "操作类型", align: "center",width:'13%'},
		       /*  {field: "proNumber", title: "编码", align: "center",width:'12%'}, */
		    ]],
