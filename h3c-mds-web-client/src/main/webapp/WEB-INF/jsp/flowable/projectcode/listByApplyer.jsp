...
<script type="text/javascript">
		...
		$("#tbl_grid${timestamp}").treegrid({
		    title:"项目编码申请",
		    url: "projectWebFlow/findProjectCodeByApplyer",
		    method : 'post',
		    idField : 'id',
		    nowrap:false,
			treeField : 'applyer',
		    ...
		    columns: [[
		        ...
		        {field: "applyer",title: "申请人",align: "left",width:'16%', formatter:formatProgress},
		        {field: "applyNo",title: "申请编号",align: "center",width:'16%'},
		        {field: "proName", title: "项目名称", align: "center",width:'16%'},
		        {field: "dept",title: "申请部门",align: "center",width:'16%'},
		        {field: "curStatus", title: "状态", align: "center",width:'16%'},
		        {field: "optType", title: "操作类型", align: "center",width:'16%'},
		       /*  {field: "proNumber", title: "编码", align: "center",width:'14%'}, */
		        
		    ]],
		    onBeforeExpand : function(row) {//异步架加载树
				var url = "projectWebFlow/findProjectCodeByApplyer";
