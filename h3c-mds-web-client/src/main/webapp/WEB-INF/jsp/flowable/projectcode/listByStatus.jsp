...
<script type="text/javascript">
		...
		$("#tbl_grid${timestamp}").treegrid({
		    title:"项目编码申请",
		    url: "projectWebFlow/findProjectCodeByStatus",
		    method : 'post',
		    idField : 'id',
		    nowrap:false,
			treeField : 'curStatus',
		    ...
		    columns: [[
		        ...
		        {field: "curStatus", title: "状态", align: "left",width:'16%', formatter:formatProgress},
		        {field: "applyer",title: "申请人",align: "center",width:'16%', formatter:formatProgress},
		        {field: "applyNo",title: "申请编号",align: "center",width:'16%', formatter:formatProgress},
		        {field: "proName", title: "项目名称", align: "center",width:'18%', formatter:formatProgress},
		        {field: "dept",title: "申请部门",align: "center",width:'16%', formatter:formatProgress},
		        {field: "optType", title: "操作类型", align: "center",width:'16%', formatter:formatProgress},
		        /* {field: "proNumber", title: "编码", align: "center",width:'13%'}, */
		    ]],
		    onBeforeExpand : function(row) {//异步架加载树
				var url = "projectWebFlow/findProjectCodeByStatus";
