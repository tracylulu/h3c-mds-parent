...
<body>
	<div id="index${id_suffix }" class="userClass">
		<!--布局-->
		<div class="index-4">
		<div class="titleClass">人员信息</div>
		<div class="searchClass" >
			<!--搜索框-->
			<input id="searchStr${id_suffix}" class="easyui-textbox" type="text" prompt="请输入搜索内容" style="width: 400px;height:30px;" />
			&nbsp;
		...
		$(function() {
			...
			$("#tg${id_suffix }").treegrid({
				...
				toolbar : [ 
				{
					...
					text : '创建${title}',
					handler : function() {
						if ($('#mainUrl').tabs('exists', "新增人员信息")) {
		           	       $('#mainUrl').tabs('select', "新增人员信息");
		           	     } else {		           	    	 
		           	       $('#mainUrl').tabs('add', {
		           	         	title : "新增人员信息",
		           	         	href : '/flowable/processConfigPerson/add',
		           	         	closable : true
		           	       });
		           	     }
					}
				...
				collapsible : false,
				url : 'flowable/processConfigPerson/listData',  /*<!--***url需要更改 ***--> */
				method : 'post',
				idField : 'code',/* <!--***idField需要更改 ***--> */
				treeField : 'name',/* <!--***treeField需要更改 ***--> */
				striped:true, 
				...
				columns:[[ 
					        ...
					        {title:'所属电子流',field:'name',width:180,formatter:function(value,row,index)
					        	{
					        ...
					        {title:'部门',field:'deptname',width:60,},    
					        {title:'人员',field:'checkerName',width:80},
					        {title:'备注',field:'note',width:80}
				]]  , 
				onBeforeExpand : function(row) {//异步架加载树
					var url = "flowable/processConfigPerson/listData";
				...
				onDblClickRow : function(rowData) {
					if(rowData!=null&& rowData.id!=null&&rowData.id!=undefined){
						 ...
						 $('#mainUrl').tabs('add',{
									title : "修改基础信息",
									href : 'flowable/processConfigPerson/edit/'+rowData.id,
									closable : true
								}); 
						}
					}					
