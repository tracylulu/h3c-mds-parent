...
public class FProjectProductRelHis {
    ...
    private Integer fProjectcodeId;
    ...
    public Integer getfProjectcodeId() {
        return fProjectcodeId;
    }

    public void setfProjectcodeId(Integer fProjectcodeId) {
        this.fProjectcodeId = fProjectcodeId;
    }
}