	...
	UPDATE IBDS_PLIPMT SET  PLIPMT_Umpire =REPLACE(REPLACE(PLIPMT_Umpire,'CN=',''),'/O=h3c',''),PLIPMT_ViceUmpire=REPLACE(REPLACE(PLIPMT_ViceUmpire,'CN=',''),'/O=h3c',''),
					...
					Readers='*/huawei-3com,*/h3c' 
					--dbo.F_RepalceGroup(Readers,0)
	...
	UPDATE IBDS_PRODLINE SET fldcpxzj=REPLACE(REPLACE(fldcpxzj,'CN=',''),'/O=h3c',''),Quality_Director_ID=REPLACE(REPLACE(Quality_Director_ID,'CN=',''),'/O=h3c',''),
			...
			Readers='*/huawei-3com,*/h3c' 
			--Readers=dbo.F_RepalceGroup(Readers,0)
...
UPDATE dbo.IBDS_bversion SET POP_ID=REPLACE(REPLACE(REPLACE(POP_ID,'CN=',''),'/O=h3c',''),'/O=huawei-3com',''),
						RNDPDT_ID=REPLACE(REPLACE(REPLACE(RNDPDT_ID,'CN=',''),'/O=h3c',''),'/O=huawei-3com',''),
						Quality_Mnger=REPLACE(REPLACE(REPLACE(Quality_Mnger,'CN=',''),'/O=h3c',''),'/O=huawei-3com',''),
						CMO_ID=REPLACE(REPLACE(REPLACE(CMO_ID,'CN=',''),'/O=h3c',''),'/O=huawei-3com',''),  
						SE=REPLACE(REPLACE(REPLACE(SE,'CN=',''),'/O=h3c',''),'/O=huawei-3com',''),
...
--UPDATE dbo.IBDS_BASE_LINE SET Readers=dbo.F_RepalceGroup(Readers,0) WHERE Readers IS NOT NULL AND Readers!='' AND Readers!='*008' AND  Readers!='*' 

--UPDATE dbo.IBDS_BASE_LINE  SET Readers=dbo.F_RepalceGroup(Readers,0) WHERE Readers!='*/O=huawei-3com,*/O=h3c' AND Readers!='*/O=huawei-3com, */O=h3c' AND  Readers!='*' AND Readers IS NOT NULL AND Readers!=''
UPDATE dbo.IBDS_BASE_LINE  SET Readers='*/huawei-3com,*/h3c'



--UPDATE dbo.IBDS_FEATRUE  SET Readers=dbo.F_RepalceGroup(Readers,0) WHERE Readers!='*/O=huawei-3com,*/O=h3c' AND  Readers!='*' AND Readers IS NOT NULL
UPDATE dbo.IBDS_FEATRUE  SET Readers='*/huawei-3com,*/h3c'

--UPDATE dbo.IBDS_SUB_FEATRUE SET Readers=dbo.F_RepalceGroup(Readers,0) WHERE Readers!='*' AND Readers IS NOT NULL
--*/huawei-3com, */h3c,
--UPDATE dbo.IBDS_SUB_FEATRUE  SET Readers=dbo.F_RepalceGroup(Readers,0) WHERE Readers!='*/O=huawei-3com,*/O=h3c' AND  Readers!='*' AND Readers IS NOT NULL
UPDATE dbo.IBDS_SUB_FEATRUE  SET Readers='*/huawei-3com,*/h3c'



--UPDATE dbo.IBDS_TEAM  SET Readers=dbo.F_RepalceGroup(Readers,0) WHERE Readers!='*/O=huawei-3com,*/O=h3c' AND  Readers!='*' AND Readers IS NOT NULL
UPDATE dbo.IBDS_TEAM  SET Readers='*/huawei-3com,*/h3c'



--UPDATE dbo.IBDS_SUB_SYSTEM  SET Readers=dbo.F_RepalceGroup(Readers,0) WHERE Readers!='*/O=huawei-3com,*/O=h3c' AND  Readers!='*' AND Readers IS NOT NULL

UPDATE dbo.IBDS_SUB_SYSTEM  SET Readers='*/huawei-3com,*/h3c'



--UPDATE dbo.IBDS_MODULE SET Readers=dbo.F_RepalceGroup(Readers,0) WHERE Readers!='*/O=huawei-3com,*/O=h3c' AND  Readers!='*' AND Readers IS NOT NULL AND Readers!='*,*'
UPDATE dbo.IBDS_MODULE SET Readers='*/huawei-3com,*/h3c'



--UPDATE dbo.IBDS_MODULE_VERSION SET Readers=dbo.F_RepalceGroup(Readers,0) WHERE Readers!='*' AND Readers IS NOT NULL

UPDATE dbo.IBDS_MODULE_VERSION SET Readers='*/huawei-3com,*/h3c'
