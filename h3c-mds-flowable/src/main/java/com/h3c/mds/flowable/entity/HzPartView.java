...
public class HzPartView {
    ...
    private String tzActualreldate;
    ...
    public String getTzActualreldate() {
        return tzActualreldate;
    }

    public void setTzActualreldate(String tzActualreldate) {
        this.tzActualreldate = tzActualreldate == null ? null : tzActualreldate.trim();
    }
}