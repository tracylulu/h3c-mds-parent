...
public class ProjectView {
    ...
    public void setProjectold(String projectold) {
        this.projectold = projectold == null ? null : projectold.trim();
    }
    ...
    public String getProjectcoacode() {
        return projectcoacode;
    }

    public void setProjectcoacode(String projectcoacode) {
        this.projectcoacode = projectcoacode == null ? null : projectcoacode.trim();
    }
    ...
    public void setProjecttypeno(String projecttypeno) {
        this.projecttypeno = projecttypeno == null ? null : projecttypeno.trim();
    }
    ...
    public void setPlOrder(String plOrder) {
        this.plOrder = plOrder == null ? null : plOrder.trim();
    }
}