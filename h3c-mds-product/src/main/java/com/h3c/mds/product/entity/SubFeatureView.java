...
public class SubFeatureView {
    private Integer id;

    private String subfeatureno;

    private String subfeature;

    private String subfeatureold;

    private String engsubfeature;
    ...
    public String getSubfeatureno() {
        return subfeatureno;
    }

    public void setSubfeatureno(String subfeatureno) {
        this.subfeatureno = subfeatureno == null ? null : subfeatureno.trim();
    }
    ...
    public void setSubfeature(String subfeature) {
        this.subfeature = subfeature == null ? null : subfeature.trim();
    }

    public String getSubfeatureold() {
        return subfeatureold;
    }

    public void setSubfeatureold(String subfeatureold) {
        this.subfeatureold = subfeatureold == null ? null : subfeatureold.trim();
    }

    public String getEngsubfeature() {
        return engsubfeature;
    }

    public void setEngsubfeature(String engsubfeature) {
        this.engsubfeature = engsubfeature == null ? null : engsubfeature.trim();
    }
