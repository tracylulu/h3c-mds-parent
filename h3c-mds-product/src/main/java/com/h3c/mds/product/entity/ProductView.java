...
public class ProductView {
    ...
    public void setCmeId(String cmeId) {
        this.cmeId = cmeId == null ? null : cmeId.trim();
    }
    ...
    public String getIfplanname() {
        return ifplanname;
    }

    public void setIfplanname(String ifplanname) {
        this.ifplanname = ifplanname == null ? null : ifplanname.trim();
    }
