...
public class IBDS_Module {
    ...
    public String getModuleold() {
        return moduleold;
    }

    public void setModuleold(String moduleold) {
        this.moduleold = moduleold == null ? null : moduleold.trim();
    }
    ...
    public void setEngmodule(String engmodule) {
        this.engmodule = engmodule == null ? null : engmodule.trim();
    }
