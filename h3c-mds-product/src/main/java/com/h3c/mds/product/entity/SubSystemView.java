...
public class SubSystemView {
    ...
    private String subsystemold;

    private String engsubsystem;
    ...
    public String getSubsystemold() {
        return subsystemold;
    }

    public void setSubsystemold(String subsystemold) {
        this.subsystemold = subsystemold == null ? null : subsystemold.trim();
    }

    public String getEngsubsystem() {
        return engsubsystem;
    }

    public void setEngsubsystem(String engsubsystem) {
        this.engsubsystem = engsubsystem == null ? null : engsubsystem.trim();
    }
