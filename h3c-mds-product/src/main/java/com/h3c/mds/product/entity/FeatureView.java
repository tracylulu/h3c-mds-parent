...
public class FeatureView {
    ...
    public String getFeatureold() {
        return featureold;
    }

    public void setFeatureold(String featureold) {
        this.featureold = featureold == null ? null : featureold.trim();
    }
    ...
    public void setEngfeature(String engfeature) {
        this.engfeature = engfeature == null ? null : engfeature.trim();
    }
