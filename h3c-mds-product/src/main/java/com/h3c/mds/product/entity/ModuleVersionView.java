...
public class ModuleVersionView {
    ...
    private String mdlvsnno;

    private String mdlvsn;

    private String mdlvsnold;

    private String engmdlvsn;
    ...
    public String getMdlvsnno() {
        return mdlvsnno;
    }

    public void setMdlvsnno(String mdlvsnno) {
        this.mdlvsnno = mdlvsnno == null ? null : mdlvsnno.trim();
    }

    public String getMdlvsn() {
        return mdlvsn;
    }

    public void setMdlvsn(String mdlvsn) {
        this.mdlvsn = mdlvsn == null ? null : mdlvsn.trim();
    }

    public String getMdlvsnold() {
        return mdlvsnold;
    }

    public void setMdlvsnold(String mdlvsnold) {
        this.mdlvsnold = mdlvsnold == null ? null : mdlvsnold.trim();
    }

    public String getEngmdlvsn() {
        return engmdlvsn;
    }

    public void setEngmdlvsn(String engmdlvsn) {
        this.engmdlvsn = engmdlvsn == null ? null : engmdlvsn.trim();
    }
    ...
    public void setSubsystemno(String subsystemno) {
        this.subsystemno = subsystemno == null ? null : subsystemno.trim();
    }
